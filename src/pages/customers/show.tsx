...
export default function CustomerShowPage() {
  ...
  // sale.total = valeur enregistrée en base, fiable. On ne la recalcule plus depuis
                    ...
                    <div className="overflow-x-auto">
                      <table className="min-w-full divide-y divide-gray-100">
                        ...
                        <tbody className="divide-y divide-gray-100 bg-white">
                          {sales.map((sale) => {
                            // sale.total = valeur enregistrée en base, fiable. On ne la recalcule
                            // plus depuis discount_percentage (arrondi à 2 décimales en base).
